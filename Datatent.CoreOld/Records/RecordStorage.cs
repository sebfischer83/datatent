...
using Datatent.Core.Interfaces.FooCore;

namespace Datatent.Core.Records
{
	/// <summary>
	...
	public class RecordStorage : IRecordStorage
	{
		...
		void AppendUInt32ToContent (IBlock block, uint value)
		{
			...
			block.Write (src: LittleEndianByteOrderHelper.GetBytes(value), srcOffset: 0, dstOffset: (int)contentLength, count: 4);
		}
		...
		uint ReadUInt32FromTrailingContent (IBlock block)
		{
			...
			return LittleEndianByteOrderHelper.GetUInt32 (buffer);
		}
